...
/______/______/______/______/______/______/______/______/______/______/[Obatula]
*******************************************************************************
''')
...
if go == "left":
    ...
    if action == "wait":
        door = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choos?\n")
        if door == "red":
